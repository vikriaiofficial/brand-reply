...
export const metadata: Metadata = {
  title: "Brand Reply | Automate SMS for Your Business",
  description: "Brand Reply is the #1 auto-reply Android app for Indian businesses. Automatically send customized business catalogs, location details, and welcome messages via SMS on missed, incoming, and outgoing calls.",
  keywords: [
    "Brand Reply",
    "Auto SMS reply app",
    "Auto SMS call reply",
  ...
  openGraph: {
    ...
    title: "Brand Reply | Automate SMS for Your Business",
    description: "Instantly reply to incoming, outgoing, or missed calls automatically via SMS. Grow your brand and save 10+ hours a week.",
  ...
  twitter: {
    ...
    title: "Brand Reply | Automate SMS for Your Business",
    description: "Instantly reply to incoming, outgoing, or missed calls automatically via SMS.",
    images: ["/logo.png"],
  },
  alternates: {
    languages: {
...
const softwareSchema = {
  ...
  "description": "Automatically send customized business catalogs, location details, and welcome messages via SMS on missed, incoming, and outgoing calls."
};
