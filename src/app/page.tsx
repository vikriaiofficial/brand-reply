...
const translations = {
  en: {
    ...
    trigger1Desc: "Customer called you? After hanging up, your business profile, offers & catalog link gets sent automatically via SMS.",
    ...
    benefitDesc: "You don't need to save every caller's number and type the same message 50 times a day. Brand Reply handles all of that silently — so you focus on real work.",
    benefit1: "Runs 24/7 in the background",
    benefit2: "Custom templates for SMS & Auto Reply",
    ...
    testimonial1Text: '"I run a boutique and used to miss 10-15 calls daily. Now every missed call gets an automatic message with my catalog. My sales went up 40% in one month!"',
    ...
    faqQ2: "Is this app safe to use?",
    faqA2: "Yes. Brand Reply sends messages only to people who called you — this is completely natural behavior. Just avoid spammy content and you're 100% safe.",
  ...
  hi: {
    ...
    heroDesc3: " — ब्रांड रिप्लाई तुरंत उन्हें एसएमएस के माध्यम से आपके व्यवसाय का विवरण, ऑफ़र और लिंक भेजता है। स्वचालित रूप से। शून्य मैन्युअल काम।",
    heroDesc4: "SMS",
    heroDesc5: " और ",
    heroDesc6: "एसएमएस",
    heroDesc7: "",
    ...
    trigger1Desc: "ग्राहक ने आपको कॉल किया? कॉल कटने के बाद, आपका व्यावसायिक प्रोफ़ाइल, ऑफ़र और कैटलॉग लिंक स्वचालित रूप से एसएमएस के माध्यम से भेजा जाता है।",
    ...
    benefitDesc: "आपको हर कॉलर का नंबर सहेजने और दिन में 50 बार एक ही संदेश टाइप करने की आवश्यकता नहीं है। ब्रांड रिप्लाई यह सब चुपचाप संभालता है — ताकि आप असली काम पर ध्यान केंद्रित कर सकें।",
    benefit1: "बैकग्राउंड में 24/7 चलता है",
    benefit2: "एसएमएस और ऑटो रिप्लाई के लिए कस्टम टेम्पलेट",
    ...
    testimonial1Text: '"मैं एक बुटीक चलाती हूँ और रोजाना 10-15 कॉल मिस करती थी। अब हर मिस्ड कॉल पर कैटलॉग के साथ एक स्वचालित संदेश जाता है। मेरी बिक्री एक महीने में 40% बढ़ गई!"',
    ...
    pricingF3: "ऑटो रिप्लाई और एसएमएस दोनों",
    pricingF4: "कस्टम संदेश टेम्पलेट",
    pricingF5: "छवियां, पीडीएफ और लिंक भेजें",
    pricingF6: "प्राथमिकता चैट सहायता",
    ...
    faqQ2: "क्या यह ऐप उपयोग करना सुरक्षित है?",
    faqA2: "हाँ। ब्रांड रिप्लाई केवल उन लोगों को संदेश भेजता है जिन्होंने आपको कॉल किया था — यह पूरी तरह से सुरक्षित है। बस स्पैम सामग्री से बचें और आप 100% सुरक्षित हैं।",
  ...
  mr: {
    ...
    heroDesc3: " — ब्रँड रिप्लाय लगेच त्यांना एसएमएसद्वारे तुमच्या व्यवसायाची माहिती, ऑफर्स आणि लिंक्स पाठवतो. ऑटोमॅटिकली. शून्य मॅन्युअल काम.",
    heroDesc4: "SMS",
    heroDesc5: " आणि ",
    heroDesc6: "एसएमएस",
    heroDesc7: "",
    ...
    trigger1Desc: "ग्राहकाने तुम्हाला कॉल केला? कॉल संपल्यानंतर, तुमचे बिझनेस प्रोफाईल, ऑफर्स आणि कॅटलॉग लिंक एसएमएसद्वारे ऑटोमॅटिकली पाठवले जाते.",
    ...
    benefitDesc: "तुम्हाला प्रत्येक कॉलरचा नंबर सेव्ह करण्याची आणि दिवसातून ५० वेळा तोच मेसेज टाईप करण्याची गरज नाही. ब्रँड रिप्लाय हे सर्व शांतपणे हाताळते — जेणेकरून तुम्ही प्रत्यक्ष कामावर लक्ष केंद्रित करू शकता.",
    benefit1: "बॅकग्राउंडमध्ये २४/७ चालते",
    benefit2: "एसएमएस आणि ऑटो रिप्लायसाठी सानुकूल टेम्पलेट्स",
    ...
    testimonial1Text: '"मी एक बुटीक चालवते आणि रोज १०-१५ कॉल्स मिस व्हायचे. आता प्रत्येक मिस कॉलवर कॅटलॉगसह ऑटोमॅटिक मेसेज जातो. माझी विक्री एका महिन्यात ४०% वाढली!"',
    testimonial1Name: "Priya Sharma",
    ...
    faqQ2: "हे अ‍ॅप वापरणे सुरक्षित आहे का?",
    faqA2: "होय. ब्रँड रिप्लाय फक्त तुम्हाला कॉल केलेल्या लोकांना मेसेज पाठवते — हे पूर्णपणे सुरक्षित आहे. फक्त स्पॅम मेसेज पाठवणे टाळा आणि तुम्ही १००% सुरक्षित आहात.",
